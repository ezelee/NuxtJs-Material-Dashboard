  ...
  export default {
    ...
    async asyncData({ $axios, error }) {
      try {
        ...
        const dailySalesChart = await EmployeeService.apiDailySalesChart()
        const dataCompletedTasksChart = await EmployeeService.apiDataCompletedTasksChart()
        const emailsSubscriptionChart = await EmployeeService.apiEmailsSubscriptionChart()
        return {
          items: items.data,
          headers: headers.data,
          dailySalesChart: dailySalesChart.data,
          dataCompletedTasksChart: dataCompletedTasksChart.data,
          emailsSubscriptionChart: emailsSubscriptionChart.data
        }
      } catch (e) {
        error({
          statusCode: 503,
